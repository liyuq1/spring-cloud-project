...
public class Test3208 {
    public static void main(String[] args) throws PKIException, IOException {
        ...
        signContractByCoordinate.setContractNo("MM20201207000000030");

        SignLocationVO[] signLocations0 = new SignLocationVO[2];
        ...
        signLocation1.setSignOnPage("1");
        signLocation1.setSignLocationLBX("85");
        signLocation1.setSignLocationLBY("550");
        signLocation1.setSignLocationRUX("240");
        signLocation1.setSignLocationRUY("675");
        signLocations0[0] = signLocation0;
        signLocations0[1] = signLocation1;
        signContractByCoordinate.setSignLocations(signLocations0);

        SignInfoVO signInfo = new SignInfoVO();
        signInfo.setUserId("71A35B81C9CF55E8E05312016B0AB80A");
        signInfo.setLocation("211.94.108.226");
        signInfo.setAuthorizationTime("20160801095509");
        signInfo.setProjectCode("001");
