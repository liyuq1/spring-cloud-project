...
public class Test3401 {
    public static void main(String[] args) throws Exception {
        ...
        localSign.setUserId("B46DAC2F4B5247CFE05312016B0A86BA");
        localSign.setProjectCode("001");

        byte[] pdfBytes = Files.readAllBytes(Paths.get("E:\\学习工程\\spring-cloud-project\\dfwy-anxinsign-utils\\src\\main\\resources\\file\\3.pdf"));
